...
import { deleteBoard } from "../features/boards/boards-slice";
   ...
   return (
      <>
        <DeleteTitle>
         ...
         <Text>
            {board && `Are you sure you want to delete the ‘${board.name}’ board? This action will remove all columns and tasks and cannot be reversed.`}
